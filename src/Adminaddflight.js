...
export default class Adminaddflight extends Component {
    ...
    handlesubmit=(e)=>{
        e.preventDefault()
        axios.post("http://localhost:5000/addflight",this.state)
        .then(result=>{
            this.setState({result:result.data})
            alert("Flight Has be Added Successfully")
    ...
    return (
      <div>
        ...
        <div style={{marginTop:"10px",marginLeft:"500px"}}>
            ...
            <span id="dn" style={{ color: "red" }}></span></div>
            <div style={{marginTop:"10px",marginLeft:"500px"}}>
...
export function Add(props){
    ...
    return(<Adminaddflight navigate={navigate}></Adminaddflight>)
  }