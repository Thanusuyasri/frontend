...
export default class Navebarwithusername extends Component {
    constructor(){
        super()
        ...
        <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
          <div className=" row navbar-nav mr-auto mt-2 mt-lg-0">
            <li className=" col nav-item active" >
             ...
             <h5 style={{marginTop: '20px'}}>{this.state.username}</h5>
              </div>
              </li>
              <li className=" col nav-item" >
            <div className="d-flex justify-content-end">
              <button className='btn btn-primary ms-auto'style={{ width: '150px'}}>
              <Link className="nav-link" to={'/userflight'}>Search-Flight</Link>
              </button>
              </div>
            </li>
              <li className=" col nav-item" >
